...
namespace Data.Implementation
{
    ...
    internal class DataRepository : IDataRepository
    {
        ...
        public override void FillStatic() => dataFill.Fill(dataContext);
        ...
        public override void DeleteUser(IUsers u) //if we have a user. 
        {
            ...
            {
                if (e.UserID == u.Id) throw new Exception("Czytelnik posiada wypozyczenie wiec nie mozna go usunac");
            }
        ...
        public override void DeleteUserWithId(string id)
        {
            foreach (var e in dataContext.events)
            {
                if (e.UserID == id) throw new Exception("Czytelnik posiada wypozyczenie wiec nie mozna go usunac");
            }
        ...
        public override void DeleteCatalogWithId(string id)
        {
            ...
            {
                if (s.BookId == id) throw new Exception("Cannot remove object. Is in use by State");
            }
        ...
        public override void DeleteCatalog(ICatalog c)// If we have a catalog.
        {
            foreach (var s in dataContext.states)
            {
                if (s.BookId == c.Id) throw new Exception("Cannot remove object. Is in use by State");
            }
